...
<div class="ps-md-4 pe-md-3 px-2 py-3 page-body">
            ...
            <ul class="row g-3 li_animate list-unstyled">
                <li class="col-lg-6 col-md-6">
                    <div class="card">
                        <div class="card-header flex-nowrap align-items-center">
                            <a href="#" class="h6 card-title mb-0">Project Doughnut Dungeon</a>
                            <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="my-4">
                                <span class="text-muted">Progress / 50%</span>
                            ...
                            <div class="hstack gap-3 mb-4">
                                <div>
                                    <p class="mb-1 text-muted small">Task: </p>
                                    287
                                </div>
                                <div class="ms-auto">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="avatar-list avatar-list-stacked d-flex">
                                    <span class="pe-3">Team</span>
                                ...
                                <a href="<?= base_url('view_posted') ?>" data-bs-toggle="offcanvas" data-bs-target="<?= base_url('view_posted') ?>">View Detail</a>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="col-lg-6 col-md-6">
                    <div class="card">
                        <div class="card-header flex-nowrap align-items-center">
                            <a href="#" class="h6 card-title mb-0">Maecenas egestas orci bibendum</a>
                            <div>
								<a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full Screen">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li class="col-lg-6 col-md-6">
                    <div class="card">
                        <div class="card-header flex-nowrap align-items-center">
                            <a href="#" class="h6 card-title mb-0">Lorem ipsum dolor sit</a>
                            <div>
								<a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full Screen">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li class="col-lg-6 col-md-6">
                    <div class="card">
                        <div class="card-header flex-nowrap align-items-center">
                            <a href="#" class="h6 card-title mb-0">Finibus rhoncus orci ante</a>
                            <div>
								<a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full Screen">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li class="col-lg-6 col-md-6">
                    <div class="card">
                        <div class="card-header flex-nowrap align-items-center">
                            <a href="#" class="h6 card-title mb-0">At ridiculus natoque vulputate</a>
                            <div>
								<a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full Screen">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li class="col-lg-6 col-md-6">
                    <div class="card">
                        <div class="card-header flex-nowrap align-items-center">
                            <a href="#" class="h6 card-title mb-0 text-truncate">Magnis nisl enim vehicula</a>
                            <div>
								<a href="#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full Screen">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="#" data-bs-toggle="offcanvas" data-bs-target="<?= base_url('view_posted') ?>">View Detail</a>
                            </div>
                        </div>
                    </div>
                </li>
