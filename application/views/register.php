    ...
    <main class="container-fluid px-0">
        ...
        <div class="px-xl-5 px-4 auth-header" data-bs-theme="none">
            <a href="index.html" class="brand-icon text-decoration-none d-flex align-items-center" title="BVITE Admin Template">
                ...
                <span class="fw-bold ps-2 fs-5 text-gradient">BVITE</span>
            </a>
        </div>
        ...
        <div class="px-xl-5 px-4 ">
            <form>
                <ul class="row g-3 list-unstyled li_animate">
                    <li class="col-12">
                        <h1 class="h2 title-font">Register Your Company</h1>
                    </li>
                    ...
                    <li class="col-12">
                        <h2 class="h5">Company Details</h2>
                    </li>
                    <li class="col-4">
                        <input type="text" class="form-control form-control-lg" placeholder="CIIN Number">
                    </li>
                    <li class="col-4">
                        <input type="text" class="form-control form-control-lg" placeholder="DIPP Number (Only for startup)">
                    </li>
                    <li class="col-4">
                    ...
                    <li class="col-12">
                        <h2 class="h5">Additional Details</h2>
                    </li>
                    <li class="col-4">
                    ...
                    <li class="col-12">
                        <span class="text-muted d-flex d-sm-inline-flex mt-3 mt-sm-0">
                            Already have an account? <a class="ms-2" href="signin.html">Sign in here</a>
                        </span>
                    </li>
                </ul>
            </form>
