				...
				<div class="mb-2">
					...
					<div class="dropdown-menu dropdown-menu-end shadow p-2 p-xl-3 rounded-4">
						<div class="bg-body p-3 rounded-3">
							<h4 class="mb-1 title-font text-gradient">Digital Bricks</h4>
							<p class="small text-muted">Digital Bricks.@gmail.com</p>
									...
									<li class="pe-2">
										<a class="d-flex p-lg-3 p-2 rounded-3" href="javascript:void(0);">
											...
											<div class="flex-fill ms-3">
												...
												<p class="mb-0 mt-1">My Digital Bricks admin template on website analytics configurations</p>
											</div>
										</a>
									</li>
								</ul>
				...
				<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvas_Navbar">
					...
					<div class="offcanvas-body flex-column custom_scroll ps-4 ps-xl-0">
						<ul class="list-unstyled mb-4 menu-list">
							<li>
								<a href="<?= base_url() ?>dashboard" aria-label="My Dashboard">
							...
							<li>
								<a href="<?= base_url('available_task') ?>" aria-label="My Wallet">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M17 8v-3a1 1 0 0 0 -1 -1h-10a2 2 0 0 0 0 4h12a1 1 0 0 1 1 1v3m0 4v3a1 1 0 0 1 -1 1h-12a2 2 0 0 1 -2 -2v-12"></path>
										<path d="M20 12v4h-4a2 2 0 0 1 0 -4h4"></path>
									</svg>
									<span class="mx-2">Available Task</span>
								</a>
							</li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="MyProject">
									<li><a href="<?= base_url('ongoing_task') ?>" aria-label="Analytics">Ongoing Task</a></li>
									<li><a href="<?= base_url('completed_task') ?>" aria-label="New Project">Completed Task</a></li>
								</ul>
							</li>
							<li>
								<a href="<?= base_url('my_wallet') ?>" aria-label="My Dashboard">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M5 12l-2 0l9 -9l9 9l-2 0"></path>
										<path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7"></path>
