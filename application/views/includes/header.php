						...
						<ul class="list-unstyled mb-4 menu-list">
                            ...
                            <li>
								...
								<ul class="collapse list-unstyled" id="MyProject">
									<li><a href="<?= base_url() ?>manage-tasks" aria-label="Analytics">Manage Tasks</a></li>
									<li><a href="<?= base_url() ?>manage-bidders" aria-label="New Project">Manage Bidders</a></li>
									<li><a href="<?= base_url() ?>active-bids" aria-label="Project List">My Active Bids </a></li>
									<li><a href="<?= base_url() ?>post-task" aria-label="Project Grid">Post a Task</a></li>
								</ul>
							</li>
                            <li>
								<a href="index.html" aria-label="My Dashboard">
									...
									<span class="mx-2">Posted Task</span>
								</a>
							</li>
