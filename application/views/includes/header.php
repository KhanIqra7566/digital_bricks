						...
						<ul class="list-unstyled mt-3">
							<li>
								<a class="dropdown-item rounded-pill" aria-label="my wallet" href="my-wallet.html">
									<span class="align-middle">Balance: <span class="fw-bold text-success"><span data-purecounter-start="0" data-purecounter-separator="," data-purecounter-currency="$" data-purecounter-end="14000" class="purecounter">0</span></span></span>
								</a>
							</li>
							...
							<div class="modal-body custom_scroll">
								<div class="container-xxl">
									...
									<ul class="row g-2 list-unstyled li_animate row-cols-lg-5 row-cols-md-3 row-cols-sm-3 row-cols-2 row-deck mb-lg-5 mb-4">
										<li class="col">
											<a class="card hr-arrow p-4" href="inbox.html" title="Inbox" style="--dynamic-color: var(--theme-color1);">
												...
												<h6 class="title mb-1">Inbox <span class="badge rounded-pill bg-warning">11</span></h6>
												<p class="small text-muted mb-0 d-none d-xl-inline-flex">Description text here...</p>
												<div class="go-corner">
										...
										<li class="col">
											<a class="card hr-arrow p-4" href="chat.html" title="Chat App" style="--dynamic-color: var(--theme-color2);">
												<svg class="mb-3" width="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										...
										<li class="col">
											<a class="card hr-arrow p-4" href="calendar.html" title="My Calendar" style="--dynamic-color: var(--theme-color3);">
												<svg class="mb-3" width="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										...
										<li class="col">
											<a class="card hr-arrow p-4" href="contact.html" title="Contact's" style="--dynamic-color: var(--theme-color5);">
												<svg class="mb-3" width="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										...
										<li class="col">
											<a class="card hr-arrow p-4" href="filemanager.html" title="File Manager" style="--dynamic-color: var(--theme-color6);">
												<svg class="mb-3" width="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="row g-5">
										<div class="col-lg-3 col-md-6 col-sm-6">
											...
											<p class="text-muted small">Lorem ipsum dolor sit amet dis sociosqu sapien.</p>
											<ul class="list-unstyled li_animate link-hover">
												<li><a href="new-project.html" aria-label="New Project">New Project</a></li>
												<li><a href="project-list.html" aria-label="Project List">Project List</a></li>
												<li><a href="project-grid.html" aria-label="Project Grid">Project Grid</a></li>
												<li><a href="project-details.html" aria-label="Project Details">Project Details</a></li>
										...
										<div class="col-lg-3 col-md-6 col-sm-6">
											...
											<p class="text-muted small">Lorem phasellus sociosqu nec turpis montes.</p>
											<ul class="list-unstyled li_animate link-hover">
												<li><a href="docs/widgets-basic-card.html" aria-label="Widgets Basic card">Basic card</a></li>
												<li><a href="docs/widgets-card-tiles.html" aria-label="Widgets tiles">Card tiles</a></li>
												<li><a href="docs/widgets-card-tab.html" aria-label="Widgets Tabbed">Tabbed card</a></li>
								...
								<div class="container-xxl">
									<div class="row g-3">
										<div class="col-auto">
											<div class="card">
												<div class="card-body d-flex align-items-center p-2">
													<div class="avatar rounded-circle no-thumbnail"><i class="fa fa-skype"></i></div>
													<div class="ms-3">
										...
										<div class="col-auto">
											<div class="card">
												<div class="card-body d-flex align-items-center p-2">
													<div class="avatar rounded-circle no-thumbnail"><i class="fa fa-envelope"></i></div>
													<div class="ms-3">
										...
										<div class="col-auto">
											<div class="card">
												<div class="card-body d-flex align-items-center p-2">
													<div class="avatar rounded-circle no-thumbnail"><i class="fa fa-phone"></i></div>
													<div class="ms-3">
				...
				<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvas_Navbar">
					...
					<div class="offcanvas-body flex-column custom_scroll ps-4 ps-xl-0">
						...
						<ul class="list-unstyled mb-4 menu-list">
							...
							<li>
								<a href="my-wallet.html" aria-label="My Wallet">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
						...
						<!-- start: Application -->
						<h6 class="fl-title title-font ps-2 small text-uppercase text-muted" style="--text-color: var(--theme-color2)">Apps</h6>
						<ul class="list-unstyled mb-4 menu-list">
							<li>
								...
								<ul class="collapse list-unstyled" id="UsersMenu">
									...
									<li><a href="account-settings.html" aria-label="Account Setting">Account Setting</a></li>
									<li><a href="invoice.html" aria-label="Invoices">Invoices</a></li>
									<li><a href="user-activity.html" aria-label="User Activity">User Activity</a></li>
									<li><a href="my-task.html" aria-label="My Tasks">My Tasks</a></li>
									<li><a href="my-contact.html" aria-label="My Contact">My Contact</a></li>
								</ul>
							</li>
							<li>
								<a href="#MyProject" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle" aria-label="My Project's">
									...
									<span class="mx-2">My Project's</span>
								</a>
								<ul class="collapse list-unstyled" id="MyProject">
									<li><a href="analytics.html" aria-label="Analytics">Analytics</a></li>
									<li><a href="new-project.html" aria-label="New Project">New Project</a></li>
									<li><a href="project-list.html" aria-label="Project List">Project List</a></li>
									<li><a href="project-grid.html" aria-label="Project Grid">Project Grid</a></li>
									<li><a href="project-details.html" aria-label="Project Details">Project Details</a></li>
							...
							<li>
								<a href="calendar.html" aria-label="My Calendar">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">My Calendar</span>
								</a>
							</li>
							<li>
								<a href="inbox.html" aria-label="Inbox">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
							...
							<li>
								<a href="chat.html" aria-label="Chat App">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
							...
							<li>
								<a href="blog.html" aria-label="Blog Article">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M8 21h8a5 5 0 0 0 5 -5v-3a3 3 0 0 0 -3 -3h-1v-2a5 5 0 0 0 -5 -5h-4a5 5 0 0 0 -5 5v8a5 5 0 0 0 5 5z"></path>
										<path d="M7 7m0 1.5a1.5 1.5 0 0 1 1.5 -1.5h3a1.5 1.5 0 0 1 1.5 1.5v0a1.5 1.5 0 0 1 -1.5 1.5h-3a1.5 1.5 0 0 1 -1.5 -1.5z"></path>
									...
									<span class="mx-2">Blog Article</span>
								</a>
							</li>
							<li>
								<a href="filemanager.html" aria-label="File Manager">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
							...
							<li>
								<a href="todo-list.html" aria-label="Todo List">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
						...
						<!-- start: Plugin -->
						<h6 class="fl-title title-font ps-2 small text-uppercase text-muted" style="--text-color: var(--theme-color3)">Plugins</h6>
						<ul class="list-unstyled mb-4 menu-list">
							<li>
								<a href="#BootstrapUI" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle" aria-label="Bootstrap UI">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Bootstrap UI</span>
								</a>
								<ul class="collapse list-unstyled" id="BootstrapUI">
									<li><a href="docs/accordion.html" aria-label="Accordion">Accordion</a></li>
									<li><a href="docs/alerts.html" aria-label="Alerts">Alerts</a></li>
									<li><a href="docs/avatar.html" aria-label="User Avatar">User Avatar</a></li>
									<li><a href="docs/badges.html" aria-label="Badges">Badges</a></li>
									<li><a href="docs/breadcrumb.html" aria-label="Breadcrumb">Breadcrumb</a></li>
									<li><a href="docs/buttons.html" aria-label="Buttons">Buttons</a></li>
									<li><a href="docs/cards.html" aria-label="Cards">Cards</a></li>
									<li><a href="docs/carousel.html" aria-label="Carousel">Carousel</a></li>
									<li><a href="docs/collapse.html" aria-label="Collapse">Collapse</a></li>
									<li><a href="docs/dropdowns.html" aria-label="Dropdowns">Dropdowns</a></li>
									<li><a href="docs/listgroup.html" aria-label="List group">List group</a></li>
									<li><a href="docs/modal.html" aria-label="Modal">Modal</a></li>
									<li><a href="docs/navbar.html" aria-label="Navbar">Navbar</a></li>
									<li><a href="docs/navstabs.html" aria-label="Navs and tabs">Navs and tabs</a></li>
									<li><a href="docs/offcanvas.html" aria-label="Offcanvas">Offcanvas</a></li>
									<li><a href="docs/pagination.html" aria-label="Pagination">Pagination</a></li>
									<li><a href="docs/placeholders.html" aria-label="Placeholders">Placeholders</a></li>
									<li><a href="docs/popovers.html" aria-label="Popovers">Popovers</a></li>
									<li><a href="docs/progress.html" aria-label="Progress">Progress</a></li>
									<li><a href="docs/spinners.html" aria-label="Spinners">Spinners</a></li>
									<li><a href="docs/toasts.html" aria-label="Toasts">Toasts</a></li>
								</ul>
							</li>
							<li>
								<a href="#FontIcon" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle" aria-label="Font icon">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Font icon</span>
								</a>
								<ul class="collapse list-unstyled" id="FontIcon">
									<li><a class="m-link" href="docs/bootstrap-icon.html" aria-label="Bootstrap Icon">Bootstrap Icon</a></li>
									<li><a class="m-link" href="docs/flag-icon.html" aria-label="Country Flag">Country Flag icon</a></li>
									<li><a class="m-link" href="docs/fontawesome-icon.html" aria-label="Font awesome">Font awesome</a></li>
									<li><a class="m-link" href="docs/linear-icon.html" aria-label="Simple line">Simple line icon</a></li>
									<li><a class="m-link" href="docs/weather-icon.html" aria-label="Weather icon">Weather icon</a></li>
								</ul>
							</li>
							<li>
								<a href="#ChartsLink" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle" aria-label="Chart's">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Charts</span>
								</a>
								<ul class="collapse list-unstyled" id="ChartsLink">
									<li><a class="m-link" href="docs/apex.html" aria-label="Apex chart">Apex chart</a></li>
									<li><a class="m-link" href="docs/peity.html" aria-label="Peity chart">Peity chart</a></li>
								</ul>
							</li>
							<li>
								<a href="docs/datatables.html" aria-label="Datatables">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path>
										<path d="M4 12l16 0"></path>
							...
							<li>
								<a href="docs/flatpickr.html" aria-label="Flatpickr">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Flatpickr</span>
								</a>
							</li>
							<li>
								<a href="docs/inputmask.html" aria-label="Inputmask">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Inputmask</span>
								</a>
							</li>
							<li>
								<a href="docs/jsvectormap.html" aria-label="Jsvectormap">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Jsvectormap</span>
								</a>
							</li>
							<li>
								<a href="docs/sortablejs.html" aria-label="Sortablejs">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Sortablejs</span>
								</a>
							</li>
							<li>
								<a href="docs/sweetalert2.html" aria-label="Sweet alert 2">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Sweet alert 2</span>
								</a>
							</li>
							<li>
								<a href="docs/tagify.html" aria-label="Tagify">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Tagify</span>
								</a>
							</li>
							<li>
								<a href="docs/tiny-slider.html" aria-label="Tiny slider">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Tiny slider</span>
								</a>
							</li>
							<li>
								<a href="docs/toast-calendar.html" aria-label="Toast Calendar">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Toast Calendar</span>
								</a>
							</li>
							<li>
								<a href="docs/toast-editor.html" aria-label="Toast editor">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Toast editor</span>
								</a>
							</li>
						</ul>
						<!-- start: More Pages -->
						<h6 class="fl-title title-font ps-2 small text-uppercase text-muted" style="--text-color: var(--theme-color4)">Pages</h6>
						<ul class="list-unstyled mb-4 menu-list">
							<li>
								<a href="#Widgets" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle" aria-label="Widgets">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"></path>
									</svg>
									<span class="mx-2">Widgets</span>
								</a>
							...
							<li>
								<a href="#Authentication" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle" aria-label="Authentication">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Authentication</span>
								</a>
							...
							<li>
								<a href="table.html" aria-label="table">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path>
										<path d="M4 12l16 0"></path>
							...
							<li>
								<a href="pricing.html" aria-label="Pricing table">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16l-3 -2l-2 2l-2 -2l-2 2l-2 -2l-3 2"></path>
										<path d="M14 8h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3h-2.5m2 0v1.5m0 -9v1.5"></path>
									</svg>
									<span class="mx-2">Pricing table</span>
								</a>
							</li>
							<li>
								<a href="gallery.html" aria-label="Imgae gallery">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<span class="mx-2">Imgae gallery</span>
								</a>
							</li>
							<li>
								<a href="search.html" aria-label="Search page">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0"></path>
										<path d="M21 21l-6 -6"></path>
									</svg>
									<span class="mx-2">Search page</span>
								</a>
							</li>
							<li>
								<a href="docs/index.html" aria-label="documentation">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"></path>
									</svg>
									<span class="mx-2">Documentation</span>
								</a>
							</li>
							<li>
								<a href="docs/changelog.html" title="Template Changelog" aria-label="Template Changelog">
									<svg class="svg-stroke" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
										<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
										<path d="M10.09 4.01l.496 -.495a2 2 0 0 1 2.828 0l7.071 7.07a2 2 0 0 1 0 2.83l-7.07 7.07a2 2 0 0 1 -2.83 0l-7.07 -7.07a2 2 0 0 1 0 -2.83l3.535 -3.535h-3.988"></path>
										<path d="M7.05 11.038v-3.988"></path>
									</svg>
									<span class="mx-2">Changelog: <b>v.1.0</b></span>
								</a>
							</li>
						</ul>
						<div class="bg-gradient rounded-3 p-4 text-white mt-4 promo">
							<p class="lh-sm fw-light">Explore our portfolio for more products.</p>
							<a href="https://themeforest.net/user/pixelwibes/portfolio" class="btn btn-sm w-100 btn-light text-uppercase" type="button">View Details</a>
						</div>
					</div>
				</div>
			</nav>
				...
				<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvas_rightbar" aria-labelledby="offcanvas_rightbar">
					...
					<div class="offcanvas-body flex-column custom_scroll" style="background: var(--body-color);">
						<ul class="nav nav-tabs tab-card justify-content-between px-0" role="tablist">
							<li class="nav-item" role="presentation"><button class="nav-link pt-0 active" data-bs-toggle="pill" data-bs-target="#pills_today" type="button" role="tab">Today</button></li>
							<li class="nav-item" role="presentation"><button class="nav-link pt-0" data-bs-toggle="pill" data-bs-target="#pills_wallet" type="button" role="tab">Wallet</button></li>
							<li class="nav-item" role="presentation"><button class="nav-link pt-0" data-bs-toggle="pill" data-bs-target="#pills_tasks" type="button" role="tab">Tasks</button></li>
						...
						<div class="tab-content mt-3">
							...
							<div class="tab-pane fade show active" id="pills_today" role="tabpanel">
									...
									<li class="col-12">
										<div class="card border-0">
											...
											<div class="card-body avatar-list avatar-list-stacked ps-4">
												<img class="avatar rounded-circle" src="assets/images/xs/avatar1.jpg" data-bs-toggle="tooltip" aria-label="Avatar" data-bs-title="Avatar" alt="avatar">
												<img class="avatar rounded-circle" src="assets/images/xs/avatar2.jpg" data-bs-toggle="tooltip" aria-label="Avatar" data-bs-title="Avatar" alt="avatar">
												<img class="avatar rounded-circle" src="assets/images/xs/avatar3.jpg" data-bs-toggle="tooltip" aria-label="Avatar" data-bs-title="Avatar" alt="avatar">
												<img class="avatar rounded-circle" src="assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" aria-label="Avatar" data-bs-title="Avatar" alt="avatar">
												<img class="avatar rounded-circle" src="assets/images/xs/avatar5.jpg" data-bs-toggle="tooltip" aria-label="Avatar" data-bs-title="Avatar" alt="avatar">
											</div>
										</div>
									</li>
									<li class="col-12">
										<div class="card border-0">
											...
											<div class="card-body d-flex align-items-start">
												...
												<div class="flex-fill ms-3">
													<h6 class="mb-4">Best of trendy design in <a href="#">2022</a> on Awwwards</h6>
													<a href="#" title="Go to Awards">Go to Awards<i class="fa fa-long-arrow-right ms-2"></i></a>
												</div>
											</div>
										</div>
									</li>
								...
								<ul class="row g-4 list-unstyled li_animate mb-0 trending-blog">
									...
									<li class="col-12 d-flex align-items-start">
										<div class="fs-3 text-muted lh-sm"><span class="d-inline-flex" style="min-width: 2.5rem;">01</span></div>
										<div class="text-truncate ms-2 ps-3 border-start dashed border-0">
											<span class="d-flex align-items-center mb-3">
												<img class="avatar sm rounded-circle border border-3 me-2" src="assets/images/xs/avatar5.jpg" alt="avatar">
												Michelle Glover
											</span>
											<h6 class="text-truncate"><a href="blog-detail.html" title="blog title" class="text-body">Unleashing the Power of ChatGPT</a></h6>
									...
									<li class="col-12 d-flex align-items-start">
										<div class="fs-3 text-muted lh-sm"><span class="d-inline-flex" style="min-width: 2.5rem;">02</span></div>
										<div class="text-truncate ms-2 ps-3 border-start dashed border-0">
											<span class="d-flex align-items-center mb-3">
												<img class="avatar sm rounded-circle border border-3 me-2" src="assets/images/xs/avatar2.jpg" alt="avatar">
												Kevin Gill
											</span>
											<h6 class="text-truncate"><a href="blog-detail.html" title="blog title" class="text-body">Designing for the Web</a></h6>
											<div class="d-flex align-items-center text-muted small">
												<span class="pe-3">Feb 20</span>
									...
									<li class="col-12 d-flex align-items-start">
										<div class="fs-3 text-muted lh-sm"><span class="d-inline-flex" style="min-width: 2.5rem;">03</span></div>
										<div class="text-truncate ms-2 ps-3 border-start dashed border-0">
											<span class="d-flex align-items-center mb-3">
												<img class="avatar sm rounded-circle border border-3 me-2" src="assets/images/xs/avatar1.jpg" alt="avatar">
												Jony Doe
											</span>
											<h6 class="text-truncate"><a href="blog-detail.html" title="blog title" class="text-body">Building Dynamic User Interfaces with Vue.js</a></h6>
											<div class="d-flex align-items-center text-muted small">
												<span class="pe-3">Feb 20</span>
							...
							<div class="tab-pane fade" id="pills_wallet" role="tabpanel">
								<ul class="row g-1 list-unstyled li_animate">
									<li class="col-12">
										<div class="card border-0">
											...
											<div class="card-body">
												...
												<div class="my-4">
													<label class="d-flex justify-content-between">Bank<span>$248,000.00</span></label>
												...
												<div class="mb-4">
													<label class="d-flex justify-content-between">Cryptocurrency<span>$12,000.00</span></label>
													<div class="progress mt-1" style="height: 1px;">
														<div class="progress-bar bg-primary" role="progressbar" aria-valuenow="56" aria-valuemin="0" aria-valuemax="100" style="width: 56%;"></div>
													</div>
												</div>
												<div class="mb-4">
													<label class="d-flex justify-content-between">Investment<span>$20,00.00</span></label>
													<div class="progress mt-1" style="height: 1px;">
									...
									<li class="col-4">
										<a href="#" class="card border-0 text-center small text-decoration-none" aria-label="Cards">
									...
									<li class="col-4">
										<a href="#" class="card border-0 text-center small text-decoration-none" aria-label="Transfer">
											<div class="card-body px-2">
												<svg class="svg-stroke mb-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
													<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<li class="col-4">
										<a href="#" class="card border-0 text-center small text-decoration-none" aria-label="Withdraw">
											<div class="card-body px-2">
												<svg class="svg-stroke mb-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
													<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
													<path d="M17 8v-3a1 1 0 0 0 -1 -1h-10a2 2 0 0 0 0 4h12a1 1 0 0 1 1 1v3m0 4v3a1 1 0 0 1 -1 1h-12a2 2 0 0 1 -2 -2v-12"></path>
									...
									<li class="col-4">
										<a href="#" class="card border-0 text-center small text-decoration-none" aria-label="Bill payments">
											<div class="card-body px-2">
												<svg class="svg-stroke mb-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
													<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
													<path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16l-3 -2l-2 2l-2 -2l-2 2l-2 -2l-3 2"></path>
									...
									<li class="col-4">
										<a href="#" class="card border-0 text-center small text-decoration-none" aria-label="Add Payee">
											<div class="card-body px-2">
												<svg class="svg-stroke mb-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
													<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
									...
									<li class="col-4">
										<a href="#" class="card border-0 text-center small text-decoration-none" aria-label="Scan & Pay">
											<div class="card-body px-2">
												<svg class="svg-stroke mb-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
													<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
							...
							<div class="tab-pane fade" id="pills_emails" role="tabpanel">
								<ul class="row g-1 list-unstyled li_animate">
									...
									<li class="col-6">
										<div class="card border-0">
											<div class="card-body p-3">
												<div class="fs-5 fw-bold"><span data-purecounter-start="0" data-purecounter-separator="," data-purecounter-end="157" class="purecounter">0</span></div>
									...
									<li class="col-6">
										<div class="card border-0">
											<div class="card-body p-3">
												<div class="fs-5 fw-bold"><span data-purecounter-start="0" data-purecounter-separator="," data-purecounter-end="723" class="purecounter">0</span></div>
									...
									<li class="col-6">
										<div class="card border-0">
											<div class="card-body p-3">
												<div class="fs-5 fw-bold"><span data-purecounter-start="0" data-purecounter-separator="," data-purecounter-end="137" class="purecounter">0</span></div>
									...
									<li class="col-6">
										<div class="card border-0">
											<div class="card-body p-3">
												<div class="fs-5 fw-bold"><span data-purecounter-start="0" data-purecounter-separator="," data-purecounter-end="42" class="purecounter">0</span></div>
									...
									<li class="col-12">
										<ul class="list-group">
											<li class="list-group-item d-flex align-items-center border-0 mb-1">
												<img class="rounded-circle avatar sm" src="assets/images/xs/avatar1.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
											...
											<li class="list-group-item d-flex align-items-center border-0 mb-1">
												<img class="rounded-circle avatar sm" src="assets/images/xs/avatar2.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
												<div class="ms-3 w-100">
											...
											<li class="list-group-item d-flex align-items-center border-0 mb-1">
												<img class="rounded-circle avatar sm" src="assets/images/xs/avatar3.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
												<div class="ms-3 w-100">
											...
											<li class="list-group-item d-flex align-items-center border-0 mb-1">
												<img class="rounded-circle avatar sm" src="assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
												<div class="ms-3 w-100">
													<a href="#" title="Github">Github</a>
			...
			<ul class="list-unstyled action d-flex align-items-center mb-0">
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end p-2 p-xl-3 shadow rounded-4">
						...
						<li><a class="dropdown-item rounded-pill" href="#">File upload</a></li>
						<li><a class="dropdown-item rounded-pill" href="#">Google docs</a></li>
						<li><a class="dropdown-item rounded-pill" href="#">Google sheets</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item rounded-pill" href="#">+ Invite</a></li>
						<li><a class="dropdown-item rounded-pill" href="#">Generate report</a></li>
						<li><a class="dropdown-item rounded-pill" href="#">New Reports</a></li>
					</ul>
				</li>
