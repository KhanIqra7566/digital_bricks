		...
		<div class="offcanvas-body">
			<div class="mb-4">
				...
				<ul class="choose-skin list-unstyled mb-0">
					<li data-theme="ValenciaRed"><div style="--bvite-theme-color: #D63B38;"></div></li>
					<li data-theme="SunOrange"><div style="--bvite-theme-color: #F7A614;"></div></li>
					<li data-theme="AppleGreen"><div style="--bvite-theme-color: #5BC43A;"></div></li>
					<li data-theme="CeruleanBlue"><div style="--bvite-theme-color: #00B8D6;"></div></li>
					<li data-theme="Mariner" class="active"><div style="--bvite-theme-color: #0066FE;"></div></li>
					<li data-theme="PurpleHeart"><div style="--bvite-theme-color: #6238B3;"></div></li>
					<li data-theme="FrenchRose"><div style="--bvite-theme-color: #EB5393;"></div></li>
				</ul>
			</div>
