<?php $this->load->view('includes/header-link.php'); ?>

<?php $this->load->view('includes/freelancer_header.php') ?>
    ...
    <div class="card border-0">
        <div class="card-body p-1">
            <div class="d-flex flex-row col-md-12">
                <div class="order-2 flex-grow-1 custom_scroll border-start">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="text-truncate user-msg">Task Application: Web Developer</span>
                                        ...
                                        <span class="small text-muted">
                                            <strong>Your application has been received and is under review.</strong>
                                        </span>
                                        <br>
                                        <span class="small text-muted">
                                            Task Completion Deadline: <strong>3 Days Remaining</strong>
                                        </span>
                                        <br>
                                        <div class="mt-2">
...
<li class="nav-item dropdown px-md-1 d-none d-md-inline-flex">
    ...
    <div class="dropdown-menu shadow rounded-4 notification">
        <div class="card border-0">
