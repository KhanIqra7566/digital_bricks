<body data-bvite="theme-CeruleanBlue" class="layout-border svgstroke-a layout-default auth">
	<main class="container-fluid px-0">
		...
		<aside class="px-xl-0 px-0 auth-aside" data-bs-theme="none">
			<img class="login-img" src="assets/images/img/login.png" alt="">
		</aside>
		<div>
			<h3 class="login-h3">Welcome to My Digital Bricks</h3>
			<p class="ps-5">Login Now</p>
		</div>
		<div class="px-xl-5 px-4 auth-body">
			<form id="login-form">
				...
				<ul class="row g-3 list-unstyled li_animate">
					<!-- <li class="col-12">
						<h1 class="h2 title-font">Welcome to Digital Bricks</h1>
					...
					<li class="col-12">
						...
						<div class="input-group">
							<input type="tel" id="phone" class="form-control form-control-lg" placeholder="Enter phone number" required>
							<button type="button" class="btn btn-outline-primary" id="send-otp">Send OTP</button>
						</div>
						<small class="text-muted">You'll receive a 6-digit OTP on this number.</small>
					</li>

					<li class="col-12" id="otp-section" style="display: none;">
						<label class="form-label">Enter OTP</label>
						<input type="text" id="otp" class="form-control form-control-lg" placeholder="Enter OTP" required>
					</li>

					<li class="col-12">
						<div class="form-check fs-5">
							<input class="form-check-input" type="checkbox" value="" id="Rememberme">
							<label class="form-check-label fs-6" for="Rememberme">Remember this Device</label>
						</div>
					</li>

					<li class="col-12 my-lg-4 d-flex justify-content-between gap-2">
						<button type="submit" class="btn btn-lg btn-primary text-uppercase w-50">Login</button>
						<a class="btn btn-lg btn-secondary w-50 d-flex align-items-center justify-content-center" href="#">
							<i class="fa fa-google me-2"></i>
							<span>Sign in with Google</span>
						</a>
					</li>

					<li class="col-12 d-flex justify-content-center mt-0">
						<span class="text-muted d-flex d-sm-inline-flex text-center">New to Digital Bricks?
							<a class="ms-2" href="<?= base_url('register') ?>" title="">Sign up here</a>
						</span>
					</li>
				</ul>
			</form>
