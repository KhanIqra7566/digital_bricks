			...
			<form>
				<ul class="row g-3 list-unstyled li_animate">
					...
					<li class="col-12">
						...
						<input type="email" class="form-control form-control-lg" placeholder="" value="admin@bvite.com">
					</li>
					<li class="col-12">
						...
						<input type="password" class="form-control form-control-lg" placeholder="" value="admin.bvite">
					</li>
					<li class="col-12">
					...
					<li class="col-12 my-lg-4">
						<a class="btn btn-lg w-100 btn-primary text-uppercase mb-2" href="<?= base_url() ?>" title="sign in">Login</a>
					...
					<li class="col-12 d-flex justify-content-center mt-0">
						<span class="text-muted d-flex d-sm-inline-flex text-center">New to Digital Bricks <a class="ms-2" href="<?= base_url('register') ?>" title="">Sign up here</a></span>
					</li>
				</ul>
			</form>
		</div>
